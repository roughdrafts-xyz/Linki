...
from sigili.commandInterfaces.cli.publish import publish
from sigili.tests.helpers import getCheckedOutDirectory, getClonedDirectory
from sigili.old_repo.remotes import sync_all_remotes
