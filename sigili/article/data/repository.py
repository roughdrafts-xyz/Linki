...
class ArticleDataRepository(ABC):
...
class MemoryArticleDataRepository(ArticleDataRepository):
    def __init__(self):
        self._log = {}
        self._data = {}
...
class BadArticleDataRepository(ArticleDataRepository):
    def add_article(self, content: bytes) -> str:
        del content
        return ''
...
class FileSystemArticleDataRepository(ArticleDataRepository):
